...
import { findProducts, getAllProduct, getProductByKhachSan } from '../../State/Product/Action'
...
const subCategories = [
  { id: 'khachsan', name: 'Khách sạn', href: '#' },
  { id: 'thuexe', name: 'Thuê xe', href: '#' },
  { id: 'thietbi', name: 'Thiết bị', href: '#' },
...
const filters = [
  
    {
      ...
      name: 'Khách và phòng',
      options: [
        { value: '1/1', label: '1 giường đơn/1 người', checked: false },
        { value: '2/2', label: '2 giường đơn/2người', checked: false },
        { value: '1/2', label: '1 giường đôi/2 người', checked: false },
        { value: '3/3', label: '3 giường đơn/3 người', checked: false },
        { value: '1/3', label: '1 giường đơn & đôi/3 người', checked: false },
      ],
    },
    {
      id: 'address',
      name: 'Địa điểm',
      options: [
        { value: 'danang', label: 'Đà Nẵng', checked: false },
        { value: 'nhatrang', label: 'Nha Trang', checked: false },
    ...
    {
      id: 'days',
      name: 'Ngày nhận, trả phòng',
      options: [
        { value: 'ngaynhan', label: 'Ngày nhận', checked: false },
        { value: 'ngaytra', label: 'Ngày trả', checked: false },
      ],
    },
    {
      id: 'price',
      name: 'Mức giá',
      options: [
        { value: '100', label: '100.000 - 500.000', checked: false },
        { value: '500.000 - 1.000.000', label: '500.000 - 1.000.000', checked: false },
        { value: '1tr-1.5r', label: '1.000.000 - 1.500.000', checked: false },
        { value: '1.5tr-2tr', label: '1.500.000 - 2.000.000', checked: false },
      ],
    },
]
...
export default function Product() {
  ...
  // const filterProduct = products.products.filter((items)=>{
...
//   useEffect(()=>{
//     const [minPrice,maxPrice]=priceValue===null?['100.000','2.000.000']:priceValue.split("-").map(Number)
...
//   },
//   // [roomValue,addressValue,daysValue,priceValue]
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Tất cả khách sạn</h1>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 w-full">
                <div className='flex flex-wrap justify-content bg-white py-5'>
                    ...
                    {/* {products && products.products?.map((item) => {
                      if (item.category && item.category.name === "khachsan") {
                        return <ProductCard key={item.id} product={item} />;
                      }
                        console.log("item.category.name nè: ",item.category.name)
                        return null;
                    })} */}
                    {/* <ProductCard/>
                    <ProductCard/>
