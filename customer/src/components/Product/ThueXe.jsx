...
const filters = [
  
    {
      ...
      name: 'Sản phẩm',
      options: [
        { value: 'oto4', label: 'Ô tô/4 chỗ', checked: false },
        { value: 'oto7', label: 'Ô tô/7 chỗ', checked: false },
        { value: 'oto16', label: 'Ô tô/16 chỗ', checked: false },
        { value: 'oto29', label: 'Ô tô/29 chỗ', checked: false },
        { value: 'oto45', label: 'Ô tô/45 chỗ', checked: false },
      ],
    },
    {
      id: 'thuonghieu',
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Tất cả xe cho thuê</h1>
