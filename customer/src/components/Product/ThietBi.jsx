...
const filters = [
  
    {
      ...
      name: 'Sản phẩm',
      options: [
        { value: 'vali', label: 'Vali & balo', checked: false },
        { value: 'leu', label: 'Lều trại', checked: false },
        { value: 'du', label: 'Dù & áo mưa', checked: false },
        { value: 'nauan', label: 'Dụng cụ nấu ăn', checked: false },
        { value: 'ga', label: 'Bình ga di động', checked: false },
      ],
    },
    {
      id: 'thuonghieu',
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Tất cả thiết bị</h1>
