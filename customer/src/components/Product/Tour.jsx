...
const filters = [
  
    {
      ...
      name: 'Sản phẩm',
      options: [
        { value: 'dai', label: 'Tour dài ngày', checked: false },
        { value: 'ngan', label: 'Tour ngắn ngày', checked: false },
      ],
    },
    {
      id: 'thuonghieu',
      name: 'Thương hiệu',
      options: [
        { value: 'cty1', label: 'Cty ABC', checked: false },
        { value: 'cty2', label: 'Cty DEF', checked: false },
        { value: 'cty3', label: 'Cty GHI', checked: false },
        { value: 'cty4', label: 'Cty JKL', checked: false },
        { value: 'cty5', label: 'Cty MNO', checked: false },
      ],
    },
    {
      id: 'danhgia',
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Tất cả tour du lịch</h1>
